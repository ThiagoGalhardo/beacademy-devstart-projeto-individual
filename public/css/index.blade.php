...
<div class="card p-3">
    ...
    <form class="row g-3">
        ...
        <div class="col-md-6 col-sm-12">
            <label for="change-address" class="form-label">Teve mudança de endereço em 2022?</label>
    ...
    <div class="row g-3">
        ...
        <div class="dataSpouse">
            ...
            <div class="col-12">
                ...
                <input type="number" class="form-control" name="cpf-spouse" id="cpf-spouse" placeholder="123.456.789-10">
            </div>
        ...
        <div class="dataDependents">
            ...
            <div class="col-12 mt-3">
                ...
                <input type="number" class="form-control" name="cpf-dependents" id="cpf-dependents" placeholder="123.456.789-10">
            </div>
        ...
        <div class="dataFed">
            ...
            <div class="col-12">
                ...
                <input type="number" class="form-control" name="cpf-fed" id="cpf-fed" placeholder="123.456.789-10">
            </div>
...
<div class="card p-3 mt-3">
    ...
    <div class="row g-3 ">
        ...
        <div class="dataMedicalExpenses">
            ...
            <p>Informar nome do convênio/plano de saúde/plano odontológico CNPJ/CPF do prestador de serviço e valor pago <br> OBS: Gastos em particular com saúde (consultas, exames, tratamento odontológico, psicólogo) enviar o recibo/nota fiscal/comprovante
                da despesa.
            </p>
            <div class="textarea-medical-expenses">
                ...
                <label for="textarea-medical-expenses">Descreva aqui</label>
            </div>
        ...
        <div class="dataEducationExpenses">
            ...
            <p>OBS: Educação básica (educação infantil, ensino fundamental e médio, ensino superior ou educação profissional).
                ...
                <br>Informar nome da instituição, CNPJ e valor pago durante o ano de 2020 .
            </p>
            <div class="textarea-education-expenses">
                ...
                <label for="textarea-education-expenses">Descreva aqui</label>
            </div>
        ...
        <div class="dataPatrimony">
            ...
            <p>Informar patrimônio (bens) em seu nome (casa, apartamento, terreno, carro, fundos de investimentos, etc.)
                <br>Informar data da compra, valor pago, forma de pagamento e situação do pagamento em 2019 e 2020, matrícula, cartório de registro, endereço completo e área total do imóvel, número do RENAVAN e placa do carro.
            ...
            <div class="textarea-patrimony">
                ...
                <label for="textarea-patrimony">Descreva aqui</label>
            </div>
...
<div class="card p-3 mt-3">
    ...
    <div class="row g-3 ">
        ...
        <div class="col-12 mt-3">
            ...
            <input type="number" class="form-control" name="bank-agency" id="bank-agency" placeholder="1605">
        </div>

        <div class="col-12 mt-3">
            <label for="bank-number" class="form-label">Número da conta</label>
            <input type="number" class="form-control" name="bank-number" id="bank-number" placeholder="Ex: 36624-4">
        </div>
...
<div class="text-center">
    <button class="btn btn-primary mt-3 px-5 py-2 btn-lg" type="submit">Finalizar
        Formulário</button>
</div>
